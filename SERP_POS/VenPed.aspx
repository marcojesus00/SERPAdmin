<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VenPed.aspx.vb" Inherits="SERP_POS.VenPed" EnableEventValidation="false" %>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width:100%; text-align:center">Pedido <asp:Label ID="lblEstado" runat="server" Text="(Abierto)" style="font-size:medium"></asp:Label></h4>

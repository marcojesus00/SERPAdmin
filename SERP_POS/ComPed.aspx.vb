Public Class ComPed
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("Usuario_Aut") = "" Or Session("Destino") <> "ComPed.aspx" Then
    ...
    Sub BuscarProductos()
        ...
        Sql = "SELECT TOP 200 A.CodArticulo Codigo, A.NomArticulo Descripcion, PrecioCompra Precio, B.Stock, A.Costo, A.Fracciones
	            FROM Articulo A
    ...
    Protected Sub TxtCodigoCliente_TextChanged(sender As Object, e As EventArgs)
        ...
        If Datos.Tables(0).Rows.Count <> 0 Then
            ...
            Session.Add("CodPrecio", Datos.Tables(0).Rows(0).Item("CodPago"))
            txtNombre.Value = Datos.Tables(0).Rows(0).Item("NombreM")
    ...
    Private Sub BtnCrear_Click(sender As Object, e As EventArgs) Handles btnCrear.Click
        ...
        For I As Integer = 0 To Session("Tabla").Rows.Count - 1
            ...
            Detalle += " INSERT INTO [dbo].[ComPedDet]
           ([NumDoc]
           ,[CodArticulo]
           ,[Descripcion]
           ,[Cantidad]
    ...
    Private Sub BtnAceptarCan_Click(sender As Object, e As EventArgs) Handles btnAceptarCan.Click
        ...
        Sql = "UPDATE ComPedEnc SET Estado = 'D' WHERE NumDoc = '" + txtNumeracion.Text + "'"
        Conf.EjecutaSql(Sql)
        Response.Redirect("ComPed.aspx")
    End Sub

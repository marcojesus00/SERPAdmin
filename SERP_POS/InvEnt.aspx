<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvEnt.aspx.vb" Inherits="SERP_POS.InvEnt" EnableEventValidation="false" %>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width:100%; text-align:center">Entrada</h4>
           ...
           <div class="container-fluid" style="background-color: rgba(0,0,0,0.6); position: absolute; left: 0; top: 0; bottom: 0" id="PanelReimprimir" runat="server" visible="false">
               <div style="padding-left: 15%; padding-right: 15%; padding-top: 40px;">
                   <div class="row" style="background-color: white; padding-top: 15px;">
                       <div class="col">
                           <div class="input-group input-group-sm">
                               <asp:TextBox ID="txtReimprimir" runat="server" CssClass="form-control form-control-sm" placeholder="Cliente..." OnTextChanged="txtReimprimir_TextChanged" AutoPostBack="true" />
                               <asp:TextBox ID="txtF1Reim" TextMode="Date" runat="server" CssClass="form-control form-control-sm" />
                               <asp:TextBox ID="txtF2Reim" TextMode="Date" runat="server" CssClass="form-control form-control-sm" />
                               <div class="input-group-append">
                                   <label class="input-group-text">
                                       <asp:LinkButton ID="btnBuscarReimp" runat="server" CssClass="fas fa-search text-secondary"></asp:LinkButton></label>
                               </div>
                           </div>
                       </div>
                       <div class="col" style="text-align: right">

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ParGArt.aspx.vb" Inherits="SERP_POS.ParGArt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Grupos de articulo</title>
 <!-- Bootstrap core CSS -->
   ...
   <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <asp:LinkButton Enabled="false" runat="server" ID="menuGrupoArt" CssClass="list-group-item list-group-item-action bg-light text-primary"><i class="fas fa-boxes"></i>&nbsp Grupos de articulos</asp:LinkButton>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width:100%; text-align:center">Grupos de articulo</h4>
                       ...
                       <asp:GridView ID="GvEncargado" runat="server" CssClass="table table-sm table-bordered table-hover" EmptyDataText="No se econtraron listas de precios" AutoGenerateColumns="False">
                           <Columns>
                               ...
                               <asp:TemplateField HeaderText="Nombre">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" Text='<%# Bind("Nombre") %>' ID="Prefijo"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>

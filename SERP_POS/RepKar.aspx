<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepKar.aspx.vb" Inherits="SERP_POS.RepKar" EnableEventValidation="false" %>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">              
               <h4 style="width:100%; text-align:center">Kardex</h4>

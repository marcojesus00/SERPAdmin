    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <div style="width:100%; height:40px; font-size:smaller; position:fixed; bottom:0px; background-color:#202020; left: 0px; color: white;"><div style="padding-top:5px;padding-left:10px;">
               <asp:Label ID="lblTotalDocumento" style="font-size:medium" runat="server"/>&nbsp&nbsp&nbsp&nbsp<asp:Label ID="lblTotalVenta" style="font-size:medium" runat="server"/>&nbsp&nbsp&nbsp&nbsp<asp:Label ID="lblTotalCosto" style="font-size:medium" runat="server"/>&nbsp&nbsp&nbsp<asp:Label ID="lblTotalGanancia" runat="server"/></div></div>

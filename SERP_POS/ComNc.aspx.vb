Public Class ComNC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("Usuario_Aut") = "" Or Session("Destino") <> "ComNC.aspx" Then
    ...
    Sub BuscarProductos()
        ...
        Sql = "SELECT TOP 200 A.CodArticulo Codigo, A.NomArticulo Descripcion, A.PrecioCompra Precio, B.Stock, A.Costo, A.Fracciones
	            FROM Articulo A
    ...
    Private Sub GvCopiar_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GvCopiar.RowCommand
        ...
        PanelTotales.Visible = True
        txtComentarios.Text = "Copiado de Factura N. " + Session("CopiaNumDoc")
        LlenarCopia()
    End Sub
    ...
    Private Sub BtnCrear_Click(sender As Object, e As EventArgs) Handles btnCrear.Click
        ...
        If Session("CopiaNumDoc").ToString.Length > 0 Then
            Estado = "C"
        Else
            Estado = "O"
        End If
    ...
    Private Sub BtnAceptarCan_Click(sender As Object, e As EventArgs) Handles btnAceptarCan.Click
        ...
        If Decimal.Parse(lblTotal.InnerText.ToString) = 0 Then
            lblMsg.Text = "Error: ND no puede ser cero"
            lblMsg.ControlStyle.CssClass = "alert alert-danger"
            Exit Sub
        End If
        ...
        For I As Integer = 0 To Session("Tabla").Rows.Count - 1
            ...
            Detalle += " INSERT INTO [dbo].[ComNdDet]
           ([NumDoc]
           ,[CodArticulo]
           ,[Descripcion]
           ,[Cantidad]

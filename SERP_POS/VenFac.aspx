<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VenFac.aspx.vb" Inherits="SERP_POS.VenFac" EnableEventValidation="false" %>
...
<body>
   ...
   <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading text-primary" style="font-weight:bolder">Ventas</div>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width:100%; text-align:center">Factura cliente <asp:Label ID="lblEstado" runat="server" Text="(Abierto)" style="font-size:medium"></asp:Label></h4>

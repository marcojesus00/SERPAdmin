<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ParImp.aspx.vb" Inherits="SERP_POS.ParImp" %>
   ...
   <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <asp:LinkButton Enabled="false" runat="server" ID="menuImpuestos" CssClass="list-group-item list-group-item-action bg-light text-primary"><i class="fas fa-coins"></i>&nbsp Impuestos</asp:LinkButton>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width:100%; text-align:center">Impuestos</h4>
                           ...
                           <Columns>
                               ...
                               <asp:TemplateField HeaderText="Descripcion">
                                ...
                                <asp:TemplateField HeaderText="Porcentaje">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" TextMode="Number" Text='<%# Bind("Porcentaje") %>' ID="Porcentaje"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                                       <asp:Label runat="server" Text='<%# Bind("Porcentaje") %>' ID="Label2"></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                           </Columns>
                       </asp:GridView>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BanRec.aspx.vb" Inherits="SERP_POS.BanRec" EnableEventValidation="false" %>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width: 100%; text-align: center">Pagos Recibidos</h4>
           ...
           <div class="container-fluid" style="padding-top: 5px;" id="PanelFactura" runat="server">
               ...
               <div class="row" style="padding-top: 15px">
                       <div class="col">
                           <div class="input-group input-group-sm">
                               <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control form-control-sm" placeholder="Buscar Factura Pendiente..." OnTextChanged="TxtBuscar_TextChanged"  AutoPostBack="true" />
                               <div class="input-group-append">

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="iniciomovil.aspx.vb" Inherits="SERP_POS.iniciomovil" %>
...
<body>    
    <form id="form1" runat="server" defaultbutton ="btnAceptarUsu">                    
        ...
        <div class="row" style="background-color:black;padding-top:5px;padding-bottom:5px;">
            <div class="col">
                <asp:LinkButton ID="btnVersion" runat="server" CssClass="btn" ForeColor="White"><i class="fas fa-drafting-compass" style="font-size: x-large;"></i>&nbsp SERP</asp:LinkButton>
            </div>
            <div class="col" style="text-align:right;">
                <asp:LinkButton ID="btnLogOut" runat="server" CssClass="btn" ForeColor="White">salir&nbsp<i class="fas fa-door-open" style="font-size: x-large;"></i></asp:LinkButton>
            </div>
        </div>   

        <div class="row" style="padding-top:3%; padding-right:3%; padding-left:3%;">
            <div class="col">
                <div id="accordion" class="shadow-sm">
                    <div class="card">
                        <div class="card-header">
                            <a class="collapsed card-link btn-block" data-toggle="collapse" href="#collapseTwo">&nbsp&nbsp<i class="fas fa-tags" style="font-size: 22px;"></i>&nbsp&nbsp Ventas</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="collapsed card-link btn-block" data-toggle="collapse" href="#collapseThree">&nbsp&nbsp<i class="fas fa-shopping-basket" style="font-size: 22px;"></i>&nbsp&nbsp Compras</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="collapsed card-link btn-block" data-toggle="collapse" href="#collapsefour">&nbsp&nbsp<i class="fas fa-pallet" style="font-size: 22px;"></i>&nbsp&nbsp Inventarios</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="collapsed card-link btn-block" data-toggle="collapse" href="#collapsefive">&nbsp&nbsp<i class="fas fa-piggy-bank" style="font-size: 22px;"></i>&nbsp&nbsp Bancos</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="collapsed card-link btn-block" data-toggle="collapse" href="#collapsesix">&nbsp&nbsp<i class="fas fa-chart-pie" style="font-size: 22px;"></i>&nbsp&nbsp Reportes</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="collapsed card-link btn-block" data-toggle="collapse" href="#collapseOne">&nbsp&nbsp<i class="fas fa-cogs" style="font-size: 22px;"></i>&nbsp&nbsp Configuraciones</a>
                        </div>
        ...
        <div class="container-fluid" style="background-color: rgba(0, 0, 0,0.8); position: absolute; left: 0; top: 0; bottom: 0" id="PanelUsuario" runat="server" visible="false">
               <div style="padding-left: 5%; padding-right:5%; padding-top:15%">
        ...
        <div style="width: 100%; height: 10%; font-size: smaller; position: fixed; bottom: 0px; background-color: #202020; left: 0px; color: white;">
            <div style="padding-top: 10px; padding-left: 10px;"><i class="far fa-envelope"></i>&nbsp<a id="Mailito" href="mailto:germandavid86@gmail.com">&nbsp germandavid86@gmail.com</a>&nbsp&nbsp&nbsp&nbsp<i class="fab fa-whatsapp"></i><a target="_blank" href="https://api.whatsapp.com/send?phone=50496516994&text=hola,%20tendo%20una%20consulta?">&nbsp 9651-6994</a></div>
        </div>

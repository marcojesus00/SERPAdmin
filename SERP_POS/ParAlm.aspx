<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ParAlm.aspx.vb" Inherits="SERP_POS.ParAlm" %>
   ...
   <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <asp:LinkButton Enabled="false" runat="server" id="MenuAlmacen" CssClass="list-group-item list-group-item-action bg-light text-primary"><i class="fas fa-warehouse"></i>&nbsp Almacenes</asp:LinkButton>
    ...
    <!-- Page Content -->
       <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
               ...
               <h4 style="width:100%; text-align:center">Almacenes</h4>
                       ...
                       <asp:GridView ID="GvEncargado" runat="server" CssClass="table table-sm table-bordered table-hover" EmptyDataText="No se econtraron listas de precios" AutoGenerateColumns="False">
                           <Columns>
                               ...
                               <asp:TemplateField HeaderText="Codigo">
                                   <EditItemTemplate>
                                       <asp:Label runat="server" CssClass="form-control form-control-sm" Text='<%# Bind("ID") %>' ID="ID"></asp:Label>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Codigo">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" CssClass="form-control form-control-sm" Text='<%# Bind("AlmacenCod") %>' ID="AlmacenCod"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                                       <asp:Label runat="server" Text='<%# Bind("AlmacenCod") %>' ID="Label1"></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>                              
                               <asp:TemplateField HeaderText="Nombre">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" CssClass="form-control form-control-sm" Text='<%# Bind("Descripcion") %>' ID="Descripcion"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Pais">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" CssClass="form-control form-control-sm" Text='<%# Bind("Pais") %>' ID="Pais"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                                       <asp:Label runat="server" Text='<%# Bind("Pais") %>' ID="Label2"></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                              <asp:TemplateField HeaderText="Ciudad">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" CssClass="form-control form-control-sm" Text='<%# Bind("Ciudad") %>' ID="Ciudad"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                                       <asp:Label runat="server" Text='<%# Bind("Ciudad") %>' ID="Label2"></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                               <asp:TemplateField HeaderText="Departamento">
                                   <EditItemTemplate>
                                       <asp:TextBox runat="server" CssClass="form-control form-control-sm" Text='<%# Bind("Departamento") %>' ID="Departamento"></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                                       <asp:Label runat="server" Text='<%# Bind("Departamento") %>' ID="Label2"></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                               <asp:TemplateField HeaderText="Activo">
                                   <EditItemTemplate>
                                       <asp:DropDownList ID="Activo" runat="server" SelectedValue='<%# Bind("Activo") %>'>
